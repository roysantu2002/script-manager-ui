...
const UserDash = () => {
  ...
  return (
    ...
    <div className={`${styles.navbarContainer}`} style={{ overflowX: 'scroll', whiteSpace: 'nowrap' }}>
        <button
          className={`nav-link ${selectedComponent === 'QuickView' ? 'active' : ''}`}
        ...
        <button
          className={`nav-link ${selectedComponent === 'DeviceLog' ? 'active' : ''}`}
        ...
        <button
          className={`nav-link ${selectedComponent === 'Hosts' ? 'active' : ''}`}
        ...
        <button
          className={`nav-link ${selectedComponent === 'RunAll' ? 'active' : ''}`}
        ...
        <button
          className={`nav-link ${selectedComponent === 'Template' ? 'active' : ''}`}
